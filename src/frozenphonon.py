...
def calculate_frozen_phonons(perovskite, xcf='PBEsol', basis='DZP', EnergyShift=0.01, SplitNorm=0.15,
                      MeshCutoff=200, kgrid=(10, 10, 10), pseudo='PBEsol', mode='lcao',
                      dir='results/bulk/frozen', par=False):
    formula = perovskite.formula
    unitcell = perovskite.atoms
